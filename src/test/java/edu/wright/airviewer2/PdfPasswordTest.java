 ...
 *
 */
public class PdfPasswordTest {
	//Here object will be initialized
	static PdfPassword pdfObj = null;
	/**
	 * @throws Exception
	 */
	@BeforeAll
	public static void setUp() throws Exception {
		...
		pdfObj = new PdfPassword("C:/Users/wsucatslabs/Desktop/Amazon/resume.pdf");
	}
	/**
	 * @throws Exception
	 */
	...
	public void test() {
		...
		try{
			 ...
			 */
			assertEquals(true,pdfObj.pdfpass("hello"));
		} 
		catch (Exception e) {
