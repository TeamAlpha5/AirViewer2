 ...
 *
 */
public class TestDocConversion {
	//Here object will be initialized
	static DocConversion pdfObj = null;
	/**
	 * @throws Exception
	 */
	@BeforeAll
	public static void setUp() throws Exception {
		...
		pdfObj = new DocConversion("C:/Users/wsucatslabs/Desktop/Amazon/resume.pdf");
	}
	/**
	 * @throws Exception
	 */
	...
	public void test() {
		...
		try{
			 ...
			 */
			assertEquals(true,pdfObj.docConversion());
		} 
		catch (Exception e) {
