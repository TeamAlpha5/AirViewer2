 ...
 *
 */
public class WatermarkadditionTest {
	//Here object will be initialized
	static Watermarkaddition pdfObj = null;
	/**
	 * @throws Exception
	 */
	@BeforeAll
	public static void setUp() throws Exception {
		...
		pdfObj = new Watermarkaddition("C:/Users/wsucatslabs/Desktop/Amazon/resume.pdf");
	}
	/**
	 * @throws Exception
	 */
	...
	public void test() {
		...
		try{
			 ...
			 */
			assertEquals(true,pdfObj.watermarkAdd());
		} 
		catch (Exception e) {
